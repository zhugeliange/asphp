...
class AS_Cart {
	...
	public function __construct($params = array())
	{
		...
		$this->AS->load->driver('session', $config);

		// Grab the shopping cart array from the session table
		$this->_cart_contents = $this->AS->session->userdata('cart_contents');
	...
	protected function _save_cart()
	{
		...
		{
			$this->AS->session->unset_userdata('cart_contents');
		...
		$this->AS->session->set_userdata(array('cart_contents' => $this->_cart_contents));
