...
class AS_Javascript {
	...
	public function __construct($params = array())
	{
		...
		$this->AS->load->library('Javascript/'.$js_library_driver, array('autoload' => $autoload));
		// make js to refer to current library
		$this->js =& $this->AS->$js_library_driver;
	...
	public function external($external_file = '', $relative = FALSE)
	{
		...
		elseif ($this->AS->config->item('javascript_location') !== '')
		{
			$this->_javascript_location = $this->AS->config->item('javascript_location');
		}
		...
		{
			$str = $this->_open_script($this->AS->config->slash_item('base_url').$this->_javascript_location.$external_file);
		}
	...
	{
		return '<script type="text/javascript" charset="'.strtolower($this->AS->config->item('charset')).'"'
			.($src === '' ? '>' : ' src="'.$src.'">');
	}
