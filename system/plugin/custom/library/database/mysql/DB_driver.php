...
abstract class AS_DB_driver {
	 ...
	 * COUNT string
	 *
	 * @used-by	AS_DB_driver::count_all()
	 * @used-by	AS_DB_query_builder::count_all_results()
	 *
	 * @var	string
	 */
	...
	{
		$driver = 'AS_DB_'.$this->dbdriver.'_result';
	...
	{
		if ( ! class_exists('AS_DB_Cache', FALSE))
		{
		...
		$this->CACHE = new AS_DB_Cache($this); // pass db object to support multiple db connections and returned db objects
		return TRUE;
	}
