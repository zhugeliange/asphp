...
class AS_Migration {
	...
	public function __construct($config = array())
	{
		...
		if ( ! in_array(get_class($this), array('AS_Migration', config_item('subclass_prefix').'Migration'), TRUE))
		{
			return;
		}
	...
	/**
	 * Enable the use of AS super-global
	 *
	 * @param	string	$var
	 * @return	mixed
	 */
