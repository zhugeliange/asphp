...
class AS_Upload {
	...
	public function do_upload($field = 'userfile')
	{
		...
		$this->file_name = $this->_AS->security->sanitize_filename($this->file_name);
	...
	public function do_xss_clean()
	{
		...
		// AS will itself look at the first 255 bytes of an image to determine its relative safety. This can save a lot of
		...
		return $this->_AS->security->xss_clean($data, TRUE);
	}
	...
	{
		$this->_AS->lang->load('upload');

		is_array($msg) OR $msg = array($msg);
		foreach ($msg as $val)
		{
			$msg = ($this->_AS->lang->line($val) === FALSE) ? $val : $this->_AS->lang->line($val);
			$this->error_msg[] = $msg;
